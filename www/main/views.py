...
from helpers import FileGetter, DropboxHelper
from django.views.decorators.csrf import csrf_exempt
from upload_handler import BitparcelUploadHandler


users_table = NoDB.Manager(DATA_DIR).getDatabase('bitparcel').getTable('users')

def front(req):
    request_dict = DropboxHelper.getRequestTokenAndUrl()
